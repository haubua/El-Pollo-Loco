...
function init() {
    ...
    <div class="spaceAround">    
        ...
        <div id="fullscreen" class="d-none">
            <img  onclick="fullscreen()" src="img/fullscreen-12-32.ico" alt="" style="margin-top: 6px";>
        </div>
    </div>`
...
function fullscreen() {
    ...
    filter: invert(1)">`
    document.getElementById('description').classList.add('invert')
    document.getElementById('headline').classList.add('d-none')
}

function closeFullscreen() {
    exitFullscreen();
    document.getElementById('description').classList.remove('invert')
